...
bdt_real = AdaBoostClassifier(
    DecisionTreeClassifier(criterion="entropy", min_samples_split=2, max_depth=10,
...
param_grid = {"n_estimators" : [1, 10, 50, 100], "learning_rate" : [.1, .2, .3, .4]}
...
print 'Accuracy of SAMME: {}'.format(bdt_discrete.score(X_test, y_test))
