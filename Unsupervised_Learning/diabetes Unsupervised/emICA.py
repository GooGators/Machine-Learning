...
projected_data = ipca.fit_transform(X)
...
for i in range(2, numPoints):
    ...
    sil.append(metrics.silhouette_score(projected_data, y_pred, metric='euclidean'))
    man.append(metrics.silhouette_score(projected_data, y_pred, metric='manhattan'))
